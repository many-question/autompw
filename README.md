...
- 根据当前配置生成 placement preview：输出 SVG/HTML/PNG，标出 overlap、clearance 不足、越界、切割方案和利用率
...
- 当前 placement 是否能找到完整 guillotine slicing tree；能找到时会列出每条垂直/水平切割通道的位置和 split counts
